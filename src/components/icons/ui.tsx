...
export const FilterDropdownIcon = ({ size = 16, className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
...
export const BackArrowIcon = ({ size = 20, className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
  ...
  >
    <path
      d="M4.16667 10L10 4.16667M4.16667 10L10 15.8333M4.16667 10H15.8333"
      stroke="currentColor"
      strokeWidth="1.66667"
      strokeLinecap="round"
      strokeLinejoin="round"
