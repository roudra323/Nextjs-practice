      ...
      <div className="relative z-10 flex flex-col lg:items-end gap-3 sm:gap-4 lg:shrink-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between lg:justify-end gap-3 sm:gap-3">
          ...
          <Link
            ...
            className="hidden sm:flex lg:hidden items-center justify-center gap-2 px-4 py-1 h-8 bg-[#0E966F] rounded-xl hover:opacity-90 transition-opacity shrink-0"
          >
            <span className="font-vietnam font-medium text-sm leading-6 tracking-[-0.3125px] text-white text-center">
              Apply as a validator
            </span>
            <LeftArrowIcon className="w-4.5 h-4.5 text-white" />
          </Link>
        </div>
        ...
        <Link
          href="/become-validator"
          className="flex sm:hidden lg:flex items-center justify-center gap-2 px-4 py-1 h-8 bg-[#0E966F] rounded-xl hover:opacity-90 transition-opacity self-end lg:self-auto shrink-0"
        >
          <span className="font-vietnam font-medium text-sm leading-6 tracking-[-0.3125px] text-white text-center">
            Apply as a validator
          </span>
