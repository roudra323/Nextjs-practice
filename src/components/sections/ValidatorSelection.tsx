...
export default function ValidatorSelection({
  onApply,
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-4 pt-6 px-6">
        ...
        <p className="font-vietnam font-medium text-base leading-7.5 tracking-[-0.04em] text-[#AAB3D0] text-center max-w-xl">
